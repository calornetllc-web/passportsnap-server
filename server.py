...
=================================================
Uses 'isnet-general-use' (ISNet) for high-accuracy detection 
of white clothing, hijabs, and light-on-light backgrounds.
"""
...
# Read Cloud Host Port dynamically or fallback to 5001 locally
HOST = "0.0.0.0"
